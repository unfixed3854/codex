...
pub(super) const KEYMAP_ACTIONS: &[KeymapActionDescriptor] = &[
    ...
    action("global", "Global", "open_model_picker", "Open the model picker without changing the current draft."),
...
pub(super) fn binding_slot<'a>(
    ...
    match (context, action) {
        ...
        ("global", "open_model_picker") => Some(&mut keymap.global.open_model_picker),
